...
<details>
<summary>✅ v1.5 Analytics Pages, Coach Dashboard & Deal Logging (Phases 44-53) — SHIPPED 2026-04-15</summary>

- [x] **Phase 44: Analytics RPC Foundation & Shared Helpers** — completed 2026-04-13
- [x] **Phase 45: `deals.logged_by` Migration + API + RLS** — completed 2026-04-13
- [x] **Phase 46: Student Analytics Page + Recharts** — completed 2026-04-13
- [x] **Phase 47: Coach Dashboard Homepage Stats** — completed 2026-04-13
- [x] **Phase 48: Full Coach Analytics Page** — completed 2026-04-13
- [x] **Phase 49: Coach & Owner Deals Logging UI** — completed 2026-04-13
...
- [x] **Phase 60: ReferralCard UI & Dashboard Integration** — student + student_diy dashboards render the referral card
...
Plans:
- [ ] 61-01-migration-00033-rpc-split-PLAN.md — Migration 00033: defensive DROP + CREATE OR REPLACE `get_student_analytics` with renamed totals jsonb keys + post-assert
- [ ] 61-02-typescript-totals-rename-PLAN.md — Rename `StudentAnalyticsTotals` fields in `src/lib/rpc/student-analytics-types.ts` (`total_emails` → `total_brand_outreach`, `total_influencers` → `total_influencer_outreach`)
- [ ] 61-03-consumer-rewrite-cache-bump-PLAN.md — Bump `unstable_cache` keys on both analytics pages to `["student-analytics-v2"]`; rewrite AnalyticsClient KPI strip (renamed cards + DIY hide-guard removed + grid simplified to `lg:grid-cols-6`)
...
| 61. Student Analytics Re-split (F1) | v1.8 | 0/TBD | Not started | — |
