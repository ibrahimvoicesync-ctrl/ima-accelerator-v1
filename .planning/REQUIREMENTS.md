...
- [x] **CHAT-01**: Coach sees a conversation list with all assigned students, showing last message preview, timestamp, and unread indicator
...
- [x] **CHAT-05**: Coach can send a broadcast message to all assigned students; students see it as a distinct system-style card with megaphone icon
