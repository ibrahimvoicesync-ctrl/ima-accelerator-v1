...
- [x] **ROADMAP-08** — Full grep sweep across codebase for hardcoded step numbers (string literals like `/10`, `/15`, `step_number === 8`, step range guards); any found are updated
