...
/** UTC-safe date string from a Date object */
...
export function CalendarTab({ sessions, reports, currentMonth, studentId, role }: CalendarTabProps) {
  ...
  // Build lookup maps from props (simple loop, <31 days of data)
  ...
  function handleMonthChange(newMonth: Date) {
    setSelectedDate(null); // clear stale detail panel on month change
