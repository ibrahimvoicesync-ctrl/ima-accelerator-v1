      ...
      <div className="w-full max-w-md rounded-xl bg-ima-surface p-8 shadow-sm border border-ima-border">
        ...
        <div className="mt-8">
          <button
            ...
            disabled={loading}
            className="flex items-center justify-center gap-3 rounded-lg border border-ima-border bg-ima-surface px-4 min-h-[44px] w-full text-sm font-medium text-ima-text hover:bg-ima-bg motion-safe:transition-colors disabled:opacity-60 disabled:cursor-not-allowed"
          >
            <svg
              width="20"
              height="20"
          ...
          <p className="mt-3 text-center text-xs text-ima-text-muted">
            Invite-only access
          </p>
